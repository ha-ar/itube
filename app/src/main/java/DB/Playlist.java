...
public class Playlist {
    ...
    public Playlist(String VideoId) {
        this.VideoId = VideoId;
    }

    public Playlist(String VideoId, String VideoTitle, String VideoDuration, String VideoViewer, String VideoUploadDate, String VideoAuthor, String VideoThumbnail) {
        this.VideoId = VideoId;
