...
public class BillingSecurity {
	...
	public static class VerifiedPurchase {
		...
		public VerifiedPurchase(C.PurchaseState purchaseState,
		...
		public boolean isPurchased() {
			return purchaseState.equals(C.PurchaseState.PURCHASED);
		}
	...
	public static ArrayList<VerifiedPurchase> verifyPurchase(String signedData,
		...
		if (!TextUtils.isEmpty(signature)) {
			 ...
			 */
			String base64EncodedPublicKey = "";
		...
		try {
			for (int i = 0; i < numTransactions; i++) {
				...
				C.PurchaseState purchaseState = C.PurchaseState.valueOf(response);
				...
				// verified nonce.
				if (purchaseState == C.PurchaseState.PURCHASED && !verified) {
					continue;
				}
